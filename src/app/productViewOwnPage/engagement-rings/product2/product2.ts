...
export class Product2 {
  ...
  product = {
    id: '2',
    name: '1ct Princess-Cut Solitaire Ring',
    price: 32000,
    image: '1ct Princess-Cut Solitaire Ring.png',
    category: 'rings',
    inStock: true,
    label: '1ct Princess-Cut Solitaire Ring',
    description: 'A modern and elegant princess-cut solitaire ring that combines contemporary style with timeless beauty.',
