...
export class Product3 {
  ...
  product = {
    id: '3',
    name: '1ct Cushion-Cut Solitaire Ring',
    price: 32000,
    image: '1ct Cushion-Cut Solitaire Ring.png',
    category: 'rings',
    inStock: true,
    label: '1ct Cushion-Cut Solitaire Ring',
    description: 'A gorgeous cushion-cut solitaire ring that showcases brilliant sparkle and vintage-inspired elegance.',
